...
\usepackage{adjustbox} %% Align figure and code in a table
\usepackage{dcolumn} %% Align decimal numbers in a table
...
\usetikzlibrary{shapes.geometric,arrows,mindmap,shadows,fadings}
...
\newcommand{\acomment}[1]{\textcolor{acolor}{A:#1}}
\newcommand{\bcomment}[1]{\textcolor{bcolor}{B:#1}}
...
%\newcommand{\revchng}[2]{#2}
\newcommand{\revchng}[2]{\redsout{#1}{\leavevmode\color{red}#2}}
